...
const HospitalDetails = () => {
    ...
    if (loading) {
        return (
            <div className='min-h-screen bg-gradient-to-br from-blue-50/50 via-transparent to-blue-50/30'>
    ...
    if (error || !hospital) {
        return (
            <div className='min-h-screen bg-gradient-to-br from-blue-50/50 via-transparent to-blue-50/30 flex items-center justify-center'>
    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-blue-50/50 via-transparent to-blue-50/30 pb-32'>
                ...
                {hospital.doctors.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-5">
                        {hospital.doctors.map((doctor) => {
                            ...
                            return (
                                <div key={doctor._id} className="relative bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:border-blue-300 transition-all duration-300 overflow-hidden group flex flex-col">
                                    ...
                                    <div className="p-4 flex flex-col items-center text-center">
                                        ...
                                        <button
                                            ...
                                            className={`w-full mt-auto py-2 px-3 rounded-lg text-xs font-semibold transition-all duration-200 flex items-center justify-center gap-1.5 shadow-sm hover:shadow-md flex-shrink-0 ${
                                                isAvailable
