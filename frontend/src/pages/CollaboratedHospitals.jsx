...
const CollaboratedHospitals = () => {
    ...
    return (
        <div className='min-h-screen pb-24 relative'>
            {/* Balanced background overlay - centered to prevent right-side shift */}
            <div 
                className="fixed inset-0 -z-10 pointer-events-none"
                style={{
                    background: `
                        radial-gradient(ellipse 120% 100% at 50% 50%, rgba(239, 246, 255, 0.5) 0%, rgba(239, 246, 255, 0.3) 30%, transparent 60%),
                        linear-gradient(to right, rgba(239, 246, 255, 0.2) 0%, transparent 20%, transparent 80%, rgba(239, 246, 255, 0.2) 100%)
                    `
                }}
            ></div>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 relative z-10">
                ...
                <div className="mb-6 flex items-center gap-2 text-sm">
                    <button
                        onClick={() => navigate('/')}
                        className="flex items-center gap-1.5 text-gray-900 hover:text-blue-600 font-bold transition-colors"
                    >
                    ...
                    <span className="text-gray-900 font-bold">Hospitals</span>
                    <span className="text-gray-300">/</span>
                    <span className="text-gray-900 font-bold">{specialtyFilter === 'All' ? 'All Hospitals' : specialtyFilter}</span>
                </div>
                    ...
                    <div className='mb-10'>
                        ...
                        <div className='relative mb-6'>
                            ...
                            <input
                                ...
                                className='w-full pl-12 pr-12 py-3.5 border border-gray-200 rounded-xl bg-white text-gray-900 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm transition-all'
                            />
                            {searchQuery && (
                                <button
                        ...
                        <div className='flex flex-wrap items-center gap-4 sm:gap-6 bg-gray-50/50 rounded-xl p-4 border border-gray-100'>
                            {/* View Filter Toggle */}
                            <div className='flex items-center gap-2 sm:gap-3'>
                                ...
                                <div className='inline-flex bg-white p-1 rounded-lg border border-gray-200 shadow-sm'>
                                    ...
                                    <button
                                        ...
                                        className={`px-3 sm:px-4 py-1.5 rounded-md text-xs sm:text-sm font-semibold transition-all flex items-center gap-1.5 sm:gap-2 ${viewMode === 'nearby'
                                            ? 'bg-blue-600 text-white shadow-sm'
                                            : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                                            }`}
                                    >
                                ...
                                <div
                                    ...
                                    onClick={() => {
                                        ...
                                        if (hospital.isRealHospital) {
                                            ...
                                            // Open in Google Maps with Name and Address
                                    ...
                                    className='group relative bg-white rounded-xl p-5 border border-gray-200 hover:shadow-lg hover:border-blue-400 transition-all duration-300 cursor-pointer flex flex-col h-full'
                                >
                                    {/* Header with Icon and Badge */}
                                    <div className='flex items-start justify-between mb-4'>
                                        <div className='w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-md group-hover:scale-105 transition-transform duration-300 relative'>
                                    ...
                                    {/* Hospital Name */}
                                    <h3 className='text-lg font-bold text-gray-900 mb-3 leading-tight line-clamp-2 min-h-[3.5rem]' title={hospital.name}>
                                        {hospital.name}
                                    </h3>
                                    ...
                                    <div className='space-y-3 flex-1'>
                                        ...
                                        <div className='flex items-start gap-2'>
                                            ...
                                            <p className='text-sm text-gray-600 leading-snug line-clamp-2 pt-1'>{hospital.address}</p>
                                        </div>
                                        ...
                                        {hospital.specialization && (
                                            <div className='flex items-center gap-2'>
                                                ...
                                                <p className='text-sm text-gray-700 font-semibold pt-1'>{hospital.specialization}</p>
                                            </div>
                                        )}
                                        ...
                                        <div className='flex items-center gap-2'>
                                            ...
                                            <p className="text-sm font-semibold text-gray-900 pt-1">{hospital.contact}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
