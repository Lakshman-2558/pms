    ...
    <div className='min-h-screen py-8 sm:py-12'>
      <div className='page-container fade-in'>
        ...
        <div className='text-center mb-8 sm:mb-10'>
          <h2 className='text-3xl sm:text-4xl font-bold text-gray-900 mb-4'>All Doctors</h2>
        ...
        {!isDoctorsLoading && (
          <div className='mb-8 space-y-4'>
            ...
            <div className='flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-3 sm:gap-4'>
              ...
              <div className='flex items-center gap-2 w-full sm:w-auto'>
                ...
                <div className='relative flex-1 sm:flex-initial'>
                  <select
                    ...
                    className='w-full sm:w-auto px-3 sm:px-4 py-1.5 sm:py-2 border border-gray-300 rounded-lg bg-white text-gray-900 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none cursor-pointer pr-7 sm:pr-8 shadow-sm sm:min-w-[150px]'
                  >
              ...
              {/* Experience Filter */}
              <div className='flex items-center gap-2 w-full sm:w-auto'>
                <label className='text-xs sm:text-sm font-medium text-gray-700 whitespace-nowrap'>Experience:</label>
                <div className='relative flex-1 sm:flex-initial'>
                  <select
                  ...
                  >
                    ...
                    <option value="Best">Best (10+ years)</option>
          ...
          <>
            {filteredAndSortedDoctors.length === 0 ? (
              ...
              <>
                ...
                {/* Doctor Cards Grid - Experts Doctor Style */}
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6'>
                      ...
                      >
                        ...
                        {doctor.available !== undefined && (
                          <div className='absolute top-3 right-3 z-10'>
                            <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-[10px] font-semibold shadow-md ${
                              doctor.available
