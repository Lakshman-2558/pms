      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className='card p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6'>
            <div className='text-center p-4 sm:p-6 rounded-xl bg-gradient-to-br from-cyan-50 to-blue-50 border border-cyan-100 hover:shadow-lg transition-shadow'>
            ...
            <div className='text-center p-4 sm:p-6 rounded-xl bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-100 hover:shadow-lg transition-shadow'>
              <div className='text-3xl sm:text-4xl mb-3 sm:mb-4'>⚡</div>
            ...
            <div className='text-center p-4 sm:p-6 rounded-xl bg-gradient-to-br from-green-50 to-teal-50 border border-green-100 hover:shadow-lg transition-shadow sm:col-span-2 md:col-span-1'>
              <div className='text-3xl sm:text-4xl mb-3 sm:mb-4'>🌐</div>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12 px-4 sm:px-0'>
          <div className='card p-4 sm:p-6 text-center hover:shadow-xl transition-shadow'>
          ...
          <div className='card p-4 sm:p-6 text-center hover:shadow-xl transition-shadow sm:col-span-2 md:col-span-1'>
            <div className='text-2xl sm:text-3xl mb-2 sm:mb-3'>⚡</div>
