...
const Banner = () => {
    ...
    return (
        <div className='relative bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 rounded-xl sm:rounded-2xl px-4 sm:px-6 md:px-10 lg:px-16 my-2 sm:my-4 md:my-6 lg:my-8 mx-2 sm:mx-4 md:mx-6 lg:mx-10 overflow-hidden group'
